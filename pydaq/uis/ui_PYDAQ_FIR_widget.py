...
################################################################################
## Form generated from reading UI file 'PYDAQ_FIR_widgetIMfjoR.ui'
##
...
"")
        ...
        self.close_fir_button = QPushButton(FIR_window)
        self.close_fir_button.setObjectName(u"close_fir_button")
        self.close_fir_button.setMaximumSize(QSize(100, 100))

        self.gridLayout.addWidget(self.close_fir_button, 2, 0, 1, 3, Qt.AlignHCenter)
    ...
    def retranslateUi(self, FIR_window):
        ...
        self.close_fir_button.setText(QCoreApplication.translate("FIR_window", u"CLOSE", None))
