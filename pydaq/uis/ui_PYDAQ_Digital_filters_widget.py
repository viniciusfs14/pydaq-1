...
"")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_4, 3, 1, 1, 1, Qt.AlignRight)
        ...
        self.gridLayout_2.addWidget(self.lineEdit, 0, 1, 1, 1, Qt.AlignRight)

        self.lineEdit_3 = QLineEdit(self.fir_configs)
        self.lineEdit_3.setObjectName(u"lineEdit_3")

        self.gridLayout_2.addWidget(self.lineEdit_3, 2, 1, 1, 1, Qt.AlignRight)
        ...
        self.gridLayout_2.addWidget(self.lineEdit_2, 1, 1, 1, 1, Qt.AlignRight)
